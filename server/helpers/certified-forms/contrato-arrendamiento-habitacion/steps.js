const steps = [
      ...
      radios: [
        {
          ...
          extraReplacements: [
            ...
            {
              identifier: 'iddec25-extra-4',
              replacement: ' y sus prórrogas',
              replacementOriginal: ' y sus prórrogas',
              insideId: 'opD'
            },
            {
              identifier: 'iddec25-extra-5',
      ...
      radios: [
        {
          label: 'Sí:',
          // tslint:disable-next-line:max-line-length
          replacementOriginal: '<br><br>El importe de los gastos de limpieza de habitación y zonas comunes no está incluido en la renta. Siendo que la parte ARRENDATARIA tendrá que abonarlos. id-dec-30_opA_1 Siendo que la parte ARRENDATARIA tendrá que abonarlos por separado a la parte ARRENDADORA, ésta, a su vez está obligada a entregar recibo a la parte ARRENDATARIA en el que se especifiquen los diferentes conceptos que componen los pagos efectuados por la parte ARRENDATARIA. id-dec-30_opA_2',
          // tslint:disable-next-line:max-line-length
      ...
      radios: [
        {
          ...
          // tslint:disable-next-line:max-line-length
          replacementOriginal: 'El pago de servicios y suministro para uso individual de la parte ARRENDATARIA correrán a cargo de esta.<br><br> id-dec-32_opA_1',
          // tslint:disable-next-line:max-line-length
          replacement: 'El pago de servicios y suministro para uso individual de la parte ARRENDATARIA correrán a cargo de esta.<br><br> id-dec-32_opA_1',
          extraReplacements: [],
      ...
      radios: [
        {
          ...
          extraReplacements: [
            {
              identifier: 'iddec36-extra-1',
              replacement: '(así como el documento Anexo al que se hace referencia en la estipulación novena)',
    ...
    },
    {
      ...
      placeholder: 'P. ej: limpiar las zoas comunes de la Vivienda (baño, salón y cocina) cada dos semanas,...',
      mandatory: false,
      isFocused: false,
      isEmpty: {
    ...
    },
    {
      ...
      placeholder: 'P. ej: La basura se divide en tres cubos: vidrio, cartón y orgánico...',
      mandatory: false,
      isFocused: false,
      isEmpty: {
    ...
    },
    {
      ...
      replacement: '',
      question: 'Si lo desea establezca unas normas acerca de los horarios dentro de la vivienda que deberá respetar el arrendatario (inquilino):',
      indications: {
        areIndications: false,
        indicationsType: '',
        value: ''
      },
      placeholder: 'P. ej: No se podrá hacer ruido en las zonas comunes a partir de las 11 de la noche hasta las 7 de la mañana...',
      mandatory: false,
      isFocused: false,
      isEmpty: {
    ...
    },
    {
      ...
      radios: [
        {
          label: 'Sí',
          replacementOriginal: '<br><br>Queda expresamente prohibido el acceso y estancia de animales domésticos o no domésticos en la habitación objeto de arrendamiento, y en el resto de la vivienda.',
          replacement: '<br><br>Queda expresamente prohibido el acceso y estancia de animales domésticos o no domésticos en la habitación objeto de arrendamiento, y en el resto de la vivienda.',
    ...
    },
    {
      ...
      radios: [
        ...
        },
        {
          ...
          subSteps: [
            {
              question: '¿Con cuántos días de anticipación deberá informar el arrendatario (inquilino) al arrendador (propietario) de su intención de subarrendar la habitación alquilada o de ceder este contrato?',
              placeholder: 'Ej. Escriba un número',
    ...
    },
    {
      ...
      replacement: '',
      question: 'Si lo desea indique la cantidad (en euros) de la multa que deberá pagar el arrendatario (inquilino) por cada día que se retrase en la devolución de la habitación una vez finalizado el contrato:',
      indications: {
        areIndications: true,
        indicationsType: 'outsideText',
        value: 'En caso de que no se deje en blanco esta pregunta, en el contrato se establecerá una multa equivalente a dos veces el importe de la renta diaria por cada día de retraso del arrendatario en la devolución de la habitación alquilada.'
      },
      placeholder: 'Escriba un número',
      mandatory: false,
      isFocused: false,
