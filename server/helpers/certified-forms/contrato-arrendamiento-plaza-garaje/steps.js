const steps = [
    ...
    },
    {
      ...
      replacement: '',
      question: 'Dirección completa de la localización de la plaza de garaje:',
      indications: {
        areIndications: true,
        indicationsType: 'insideText',
        value: 'Dirección completa (tipo y nombre de la vía, número, código postal, localidad, provincia y país) '
      },
      placeholder: 'P. ej: Paseo de las Yeserías 11, 28005, Madrid, España',
      mandatory: false,
      isFocused: false
    },
    {
    ...
    },
    {
      ...
      radios: [
        {
          label: 'Sí',
          replacementOriginal: 'e) incumplimiento de las normas de convivencia establecidas por la Comunidad de Propietarios por la parte ARRENDATARIA',
          replacement: 'e) incumplimiento de las normas de convivencia establecidas por la Comunidad de Propietarios por la parte ARRENDATARIA',
                  ...
                  subSteps: [
                    {
                      ...
                      indications: {
                        ...
                        indicationsType: 'outsideText',
                        // tslint:disable-next-line:max-line-length
                        value: 'Si lo desea, indique aquí el nombre o denominación del índice que las partes prevén en el contrato de alquiler para actualizar la renta; es decir para revisar el valor o precio del alquiler de la plaza de garaje objeto de este contrato con la periodicidad o frecuencia que ha sido determinada.<br> Si no desea prever un índice, en el contrato se establecerá la actualización de la renta por referencia al Índice de Garantía de Competitividad (IGC) fijado por el Instituto Nacional de Estadística.'
                      },
                      rules: [],
                    }
                  ]
      ...
      radios: [
        {
          label: 'Sí',
          // tslint:disable-next-line:max-line-length
          replacementOriginal: 'Las partes acuerdan un importe de iddec34opA1-precioAletras (id-dec-34_opA_1 €) en concepto de fianza, que la parte ARRENDATARIA entrega en este acto a la parte ARRENDADORA. Sirva el presente documento la más formal y fiel carta de pago que en derecho corresponda. <br><br> Una vez la parte ARRENDADORA haya comprobado que la  plaza de garaje se encuentra en perfecto estado y conservación, el importe correspondiente a la fianza será devuelto a la parte ARRENDATARIA. En el caso de que existieran deudas o cantidades pendientes de abono, o bien, se hubiere ocasionado desperfectos en la plaza de garaje, debido a su mal uso, será descontado de la fianza el importe correspondiente necesario para reparar los desperfectos ocasionados.',
          // tslint:disable-next-line:max-line-length
          replacement: 'Las partes acuerdan un importe de iddec34opA1-precioAletras (id-dec-34_opA_1 €) en concepto de fianza, que la parte ARRENDATARIA entrega en este acto a la parte ARRENDADORA. Sirva el presente documento la más formal y fiel carta de pago que en derecho corresponda. <br><br> Una vez la parte ARRENDADORA haya comprobado que la  plaza de garaje se encuentra en perfecto estado y conservación, el importe correspondiente a la fianza será devuelto a la parte ARRENDATARIA. En el caso de que existieran deudas o cantidades pendientes de abono, o bien, se hubiere ocasionado desperfectos en la plaza de garaje, debido a su mal uso, será descontado de la fianza el importe correspondiente necesario para reparar los desperfectos ocasionados.',
          extraReplacements: [],
