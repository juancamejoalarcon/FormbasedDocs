const steps = [
  {
    ...
    description: `Un contrato de trabajo es un acuerdo entre un trabajador y un empresario, 
    mediante el cual se podrá regular la relación laboral tanto de carácter indefinido como de 
    carácter temporal, estableciendo una jornada laboral completa o de tipo parcial.`,
    isCurrentStep: true
  },
  {
    "replacement": "",
    "identifier": "id-dec-0",
    "wordToReplace": "id-dec-0",
    fixContratoTrabjo: true,
    ...
    "extraReplacements": [
      {
        "identifier": "iddec0-extra-0",
        "wordToReplace": "iddec0-extra-0",
        "insideId": "opA"
      },
      {
        "identifier": "iddec0-extra-1",
        "wordToReplace": "iddec0-extra-1",
        "insideId": "opB"
      },
      {
        "identifier": "iddec0-extra-2",
        "wordToReplace": "iddec0-extra-2",
        "insideId": "opC"
      },
      {
        "identifier": "iddec0-extra-3",
        "wordToReplace": "iddec0-extra-3",
        "insideId": "opD"
      },
      {
        "identifier": "iddec0-extra-4",
        "wordToReplace": "iddec0-extra-4",
        "insideId": "opE"
      }
    ],
    "radios": [
      {
        "label": "indefinida (contrato indefinido)",
        "replacement": "indefinido",
        "replacementOriginal": "indefinido",
        "radioId": "id-dec-0_opA",
        "identifier": "id-dec-0_opA",
        "subSteps": [],
        "extraReplacements": [
          {
            "identifier": "iddec0-extra-0",
          ...
          },
          {
            "identifier": "iddec0-extra-1",
            "insideId": "opB",
            "replacement": "El TRABAJADOR prestará sus servicios en el puesto de: id-dec-21. De acuerdo con el sistema de clasificación profesional vigente en la empresa, estará incluida en el grupo profesional de: id-dec-20, y realizará las siguientes funciones:",
            "replacementOriginal": "El TRABAJADOR prestará sus servicios en el puesto de: id-dec-21. De acuerdo con el sistema de clasificación profesional vigente en la empresa, estará incluida en el grupo profesional de: id-dec-20, y realizará las siguientes funciones:"
          },
          {
            "identifier": "iddec0-extra-2",
            "insideId": "opC",
            "replacement": "La duración del presente Contrato será indefinida, iniciándose la relación laboral el día id-dec-26.",
            "replacementOriginal": "La duración del presente Contrato será indefinida, iniciándose la relación laboral el día id-dec-26."
          },
          {
            "identifier": "iddec0-extra-3",
            "insideId": "opD",
          ...
          },
          {
            "identifier": "iddec0-extra-4",
            "insideId": "opE",
            "replacement": "Particularmente, se regirá por el Estatuto de los Trabajadores, aprobado por el Real Decreto Legislativo 2/2015, de 23 de octubre",
            "replacementOriginal": "Particularmente, se regirá por el Estatuto de los Trabajadores, aprobado por el Real Decreto Legislativo 2/2015, de 23 de octubre"
          }
        ],
        "checked": true
      },
      {
        "label": "determinada (contrato temporal)",
        "replacement": "id-dec-0_opB_0",
        "replacementOriginal": "id-dec-0_opB_0",
        "radioId": "id-dec-0_opB",
        "identifier": "id-dec-0_opB",
        "subSteps": [
          {
            "replacement": "",
            "identifier": "id-dec-0_opB_0",
            "wordToReplace": "id-dec-0_opB_0",
            "question": "Razón que justifica la celebración de este contrato temporal:",
            "type": "iRadioC",
            "subType": "select",
            "indications": {
              "areIndications": false,
            ...
            "extraReplacements": [
              {
                "identifier": "iddec0_opB_0-extra-0",
                "wordToReplace": "iddec0_opB_0-extra-0",
                "insideId": "opA"
              },
              {
                "identifier": "iddec0_opB_0-extra-1",
                "wordToReplace": "iddec0_opB_0-extra-1",
                "insideId": "opB"
              },
              {
                "identifier": "iddec0_opB_0-extra-2",
                "wordToReplace": "iddec0_opB_0-extra-2",
                "insideId": "opC"
              }
            ],
            "radios": [
              {
                "label": "la realización de una obra o un servicio determinados",
                "replacement": "temporal de obra o servicio determinado",
                "replacementOriginal": "temporal de obra o servicio determinado",
                "radioId": "id-dec-0_opB_0_opA",
                "identifier": "id-dec-0_opB_0_opA",
                fixContratoTrabjo: true,
                "subSteps": [
                  {
                    "replacement": "",
                    "identifier": "id-dec-0_opB_0_opA_0",
                    "wordToReplace": "id-dec-0_opB_0_opA_0",
                    "question": "Descripción de la obra o los servicios concretos:",
                    "placeholder": "P. ej: Realización de un programa informático",
                    "mandatory": false,
                    "isFocused": false,
                    "type": "iText",
                    "subType": "textarea",
                    "indications": {
                      ...
                      "value": "De acuerdo al Estatuto de los Trabajadores, aunque la duración de esta obra o servicio es incierta, en ningún caso puede ser indefinida ni superior a 3 años, y debe tener autonomía y sustantividad propia dentro de la actividad de la empresa. En ocasiones, los convenios colectivos establecen listados de los trabajos o tareas que tienen esa autonomía y sustantividad y que se pueden cubrir, por tanto, por contratos de obra o servicio.\n\t\t\t\t\t\t\t\t\t\t\t "
                    }
                  }
                ],
                "extraReplacements": [
                  {
                    "identifier": "iddec0_opB_0-extra-0",
                    "insideId": "opA",
                    "replacement": "El presente Contrato de trabajo se celebra para la realización de la siguiente obra o servicio determinado: id-dec-0_opB_0_opA_0. De conformidad con lo establecido en el artículo 15 del Estatuto de los Trabajadores, dicha obra o servicio tiene autonomía y sustantividad propia dentro de la actividad de la empresa, y su duración no superará los tres años.\n\nEn el marco de esta, el TRABAJADOR prestará sus servicios en el puesto de: id-dec-21. De acuerdo con el sistema de clasificación profesional vigente en la empresa, estará incluida en el grupo profesional de: id-dec-20, y realizará las siguientes funciones:",
                    "replacementOriginal": "El presente Contrato de trabajo se celebra para la realización de la siguiente obra o servicio determinado: id-dec-0_opB_0_opA_0. De conformidad con lo establecido en el artículo 15 del Estatuto de los Trabajadores, dicha obra o servicio tiene autonomía y sustantividad propia dentro de la actividad de la empresa, y su duración no superará los tres años.\n\nEn el marco de esta, el TRABAJADOR prestará sus servicios en el puesto de: id-dec-21. De acuerdo con el sistema de clasificación profesional vigente en la empresa, estará incluida en el grupo profesional de: id-dec-20, y realizará las siguientes funciones:"
                  },
                  {
                    "identifier": "iddec0_opB_0-extra-1",
                    "insideId": "opB",
                    "replacement": "La duración del presente Contrato se extenderá desde el id-dec-26 hasta la finalización de la realización de la obra y/o el servicio descritos en la estipulación primera de este Contrato.",
                    "replacementOriginal": "La duración del presente Contrato se extenderá desde el id-dec-26 hasta la finalización de la realización de la obra y/o el servicio descritos en la estipulación primera de este Contrato.",
                  },
                  {
                    "identifier": "iddec0_opB_0-extra-2",
                    "insideId": "opC",
                    "replacement": "A la finalización del Contrato por la realización de la obra o el servicio que constituye su objeto, el TRABAJADOR tendrá derecho a recibir una indemnización de acuerdo con la Disposición Transitoria Octava del Estatuto de los Trabajadores.Al haberse celebrado el presente Contrato después del 1 de enero de 2015, la cuantía de dicha indemnización será equivalente a doce días de salario por cada año de servicio.",
                    "replacementOriginal": "A la finalización del Contrato por la realización de la obra o el servicio que constituye su objeto, el TRABAJADOR tendrá derecho a recibir una indemnización de acuerdo con la Disposición Transitoria Octava del Estatuto de los Trabajadores.Al haberse celebrado el presente Contrato después del 1 de enero de 2015, la cuantía de dicha indemnización será equivalente a doce días de salario por cada año de servicio."
                  }
                ],
                "checked": true
              },
              {
                "label": "las circunstancias de la producción (ej. acumulación de tareas)",
                "replacement": "temporal eventual por circunstancias de la producción",
                "replacementOriginal": "temporal eventual por circunstancias de la producción",
                "radioId": "id-dec-0_opB_0_opB",
                "identifier": "id-dec-0_opB_0_opB",
                fixContratoTrabjo: true,
                "subSteps": [
                  {
                    "replacement": "",
                    "identifier": "id-dec-0_opB_0_opB_0",
                    "wordToReplace": "id-dec-0_opB_0_opB_0",
                    "question": "Descripción de las circunstancias de la producción que justifican la celebración del contrato temporal:",
                    "placeholder": "P. ej. La empresa debe responder a la alta demanda de pedidos de comida debido a la alta afluencia de gente por una feria local.",
                    "mandatory": false,
                    "isFocused": false,
                    "type": "iText",
                    "subType": "textarea",
                    "indications": {
                      "areIndications": true,
                      "indicationsType": "insideText",
                      "value": "Puede tratarse de exigencias circunstanciales del mercado, acumulación de tareas o exceso de pedidos, aun tratándose de la actividad normal de la empresa. Se debe tratar de circunstancias que no pudieron ser previstas; es decir, que no son cíclicas.\t\t\t\t\t\t\t\t\t\t "
                    }
                  },
                  {
                    "replacement": "",
                    "identifier": "id-dec-0_opB_0_oB_1",
                    "wordToReplace": "id-dec-0_opB_0_oB_1",
                    "question": "Fecha de finalización del contrato de trabajo:",
                    "placeholder": "P. ej. La empresa debe responder a la alta demanda de pedidos de comida debido a la alta afluencia de gente por una feria local.",
                    "mandatory": false,
                    "isFocused": false,
                    "type": "iDate",
                    ...
                    "indications": {
                      "areIndications": true,
                      "indicationsType": "outsideText",
                      "value": "En el caso de los contratos de obra o servicio determinado, la fecha de término (y el plazo de duración) se considerará orientativo. La fecha de término no puede ser más de tres años posterior a la fecha de incorporación del trabajador a su puesto de trabajo, salvo que el convenio colectivo aplicable permita una duración mayor (hasta 12 meses más). En el caso de los contratos eventuales por circunstancias de la producción, esta fecha no puede ser más de seis meses posterior a la fecha de incorporación del trabajador a su puesto de trabajo (dentro de un período de 12 meses), salvo que el convenio colectivo aplicable permita una duración mayor (hasta 12 meses, dentro de un período de referencia de hasta 18 meses)."
                    }
                  }
                ],
                "extraReplacements": [
                  {
                    "identifier": "iddec0_opB_0-extra-0",
                    "insideId": "opA",
                    "replacement": "El presente Contrato de trabajo se celebra para, aún tratándose de la actividad normal de la empresa, atender a las exigencias circunstanciales del mercado, acumulación de tareas o exceso de pedidos, consistentes en: id-dec-0_opB_0_opB_0.\n\nPor consiguiente, el TRABAJADOR prestará sus servicios en el puesto de: id-dec-21. De acuerdo con el sistema de clasificación profesional vigente en la empresa, estará incluida en el grupo profesional de: id-dec-20, y realizará las siguientes funciones:",
                    "replacementOriginal": "El presente Contrato de trabajo se celebra para, aún tratándose de la actividad normal de la empresa, atender a las exigencias circunstanciales del mercado, acumulación de tareas o exceso de pedidos, consistentes en: id-dec-0_opB_0_opB_0.\n\nPor consiguiente, el TRABAJADOR prestará sus servicios en el puesto de: id-dec-21. De acuerdo con el sistema de clasificación profesional vigente en la empresa, estará incluida en el grupo profesional de: id-dec-20, y realizará las siguientes funciones:"
                  },
                  {
                    "identifier": "iddec0_opB_0-extra-1",
                    "insideId": "opB",
                    "replacement": "La duración del presente Contrato se extenderá desde el id-dec-26 hasta el id-dec-0_opB_0_oB_1, de conformidad con la duración máxima establecida en el Estatuto de los Trabajadores.",
                    "replacementOriginal": "La duración del presente Contrato se extenderá desde el id-dec-26 hasta el id-dec-0_opB_0_oB_1, de conformidad con la duración máxima establecida en el Estatuto de los Trabajadores."
                  },
                  {
                    "identifier": "iddec0_opB_0-extra-2",
                    "insideId": "opC",
                    "replacement": "A la finalización del Contrato por expiración del tiempo convenido en la estipulación cuarta, el TRABAJADOR tendrá derecho a recibir una indemnización de acuerdo con la Disposición Transitoria Octava del Estatuto de los Trabajadores.Al haberse celebrado el presente Contrato después del 1 de enero de 2015, la cuantía de dicha indemnización será equivalente a doce días de salario por cada año de servicio.",
                    "replacementOriginal": "A la finalización del Contrato por expiración del tiempo convenido en la estipulación cuarta, el TRABAJADOR tendrá derecho a recibir una indemnización de acuerdo con la Disposición Transitoria Octava del Estatuto de los Trabajadores.Al haberse celebrado el presente Contrato después del 1 de enero de 2015, la cuantía de dicha indemnización será equivalente a doce días de salario por cada año de servicio."
                  }
                ],
                "checked": false
              },
              {
                "label": "la sustitución de un trabajador",
                "replacement": "temporal de interinidad",
                "replacementOriginal": "temporal de interinidad",
                "radioId": "id-dec-0_opB_0_opC",
                "identifier": "id-dec-0_opB_0_opC",
                fixContratoTrabjo: true,
                "subSteps": [
                  {
                    "replacement": "",
                    "identifier": "id-dec-0_opB_0_opC_1",
                    "wordToReplace": "id-dec-0_opB_0_opC_1",
                    "question": "Nombre completo del trabajador sustituido:",
                  ...
                  {
                    type: 'iRadioB',
                    question: 'Tipo de documento de identificación del sustituido:',
                    identifier: 'id-dec-0_opB_0_opC_2',
                    wordToReplace: 'id-dec-0_opB_0_opC_2',
                    indications: {
                      areIndications: true,
                      indicationsType: 'outsideText',
                    ...
                    replacement: '',
                    extraReplacements: [],
                    defaultRadioId: 'id-dec-0_opB_0_opC_2_opA',
                    radios: [
                      {
                        label: 'DNI',
                        replacementOriginal: 'DNI',
                        replacement: '',
                        radioId: 'id-dec-0_opB_0_opC_2_opA',
                        identifier: 'id-dec-0_opB_0_opC_2_opA',
                        extraReplacements: [],
                        checked: true,
                      },
                      {
                        ...
                        replacement: '',
                        radioId: 'id-dec-0_opB_0_opC_2_opB',
                        identifier: 'id-dec-0_opB_0_opC_2_opB',
                        extraReplacements: [],
                        checked: false,
                      },
                      {
                        ...
                        replacement: '',
                        radioId: 'id-dec-0_opB_0_opC_2_opC',
                        identifier: 'id-dec-0_opB_0_opC_2_opC',
                        extraReplacements: [],
                        checked: false,
                      }
                    ]
                  },
                  {
                    ...
                    wordToReplace: 'id-dec-0_opB_0_opC_3',
                    identifier: 'id-dec-0_opB_0_opC_3',
                    type: 'iText',
                    replacement: '',
                  ...
                  {
                    question: 'Causa de la sustitución de dicho trabajador:',
                    wordToReplace: 'id-dec-0_opB_0_opC_4',
                    identifier: 'id-dec-0_opB_0_opC_4',
                    type: 'iText',
                    subType: 'textarea',
                    replacement: '',
                    placeholder: 'P. ej. derecho a reserva del puesto de trabajo',
                    indications: {
                      areIndications: true,
                      indicationsType: 'insideText',
                      value: '<p>Algunas causas de sustitución son las siguientes:</p><ul> <li>derecho a reserva del puesto de trabajo</li><li>cubrir temporalmente un puesto de trabajo durante el proceso de selección o promoción para su cobertura definitiva</li><li>baja por paternidad/maternidad (sin bonificación de cuotas SS)</li><li>trabajador(a) excedente por cuidados familiares sustituido/a por un desempleado de larga duración</li><li>trabajador(a) en formación sustituido/a por un(a) beneficiario/a de prestaciones por desempleo</li><li>trabajador(a) con discapacidad con contrato suspendido por incapacidad temporal sustituido/a por persona con discapacidad</li><li>trabajadora víctima de violencia de género con contrato de trabajo suspendido</li><li>trabajadora víctima de violencia de género que se cambia o traslada de centro de trabajo</li><li>trabajador(a) con contrato de trabajo suspendido durante la baja por maternidad/paternidad (con bonificación de cuotas SS)</li><li>trabajador(a) con contrato de trabajo suspendido durante la baja por adopción (con bonificación de cuotas SS)</li><li>trabajador(a) con contrato de trabajo suspendido durante la baja por acogimiento preadoptivo o permanente (con bonificación de cuotas SS)</li><li>trabajadora con contrato de trabajo suspendido por riesgo durante el embarazo (con bonificación de cuotas SS)</li><li>trabajadora con contrato de trabajo suspendido por riesgo durante la lactancia natural (con bonificación de cuotas SS)</li><li>trabajador(a) autónomo/a sustituido/a por conciliación de la vida profesional y familiar</li></ul>',
                    },
                  }
                ],
                "extraReplacements": [
                  {
                    "identifier": "iddec0_opB_0-extra-0",
                    "insideId": "opA",
                    "replacement": "El presente Contrato de trabajo se celebra para sustituir al siguiente trabajador: id-dec-0_opB_0_opC_1, con id-dec-0_opB_0_opC_2 id-dec-0_opB_0_opC_3. La causa de la sustitución es la siguiente: id-dec-0_opB_0_opC_4.\n\nPor consiguiente, el TRABAJADOR prestará sus servicios en el puesto de: id-dec-21, que corresponde al puesto de trabajo desempeñado anteriormente por el trabajador sustituido. De acuerdo con el sistema de clasificación profesional vigente en la empresa, estará incluida en el grupo profesional de: id-dec-20, y realizará las siguientes funciones:",
                    "replacementOriginal": "El presente Contrato de trabajo se celebra para sustituir al siguiente trabajador: id-dec-0_opB_0_opC_1, id-dec-0_opB_0_opC_2 id-dec-0_opB_0_opC_3. La causa de la sustitución es la siguiente: id-dec-0_opB_0_opC_4.\n\nPor consiguiente, el TRABAJADOR prestará sus servicios en el puesto de: id-dec-21, que corresponde al puesto de trabajo desempeñado anteriormente por el trabajador sustituido. De acuerdo con el sistema de clasificación profesional vigente en la empresa, estará incluida en el grupo profesional de: id-dec-20, y realizará las siguientes funciones:"
                  },
                  {
                    "identifier": "iddec0_opB_0-extra-1",
                    "insideId": "opB",
                    "replacement": "La duración del presente Contrato se extenderá desde el id-dec-26 hasta que dure la ausencia del trabajador sustituido.",
                    "replacementOriginal": "La duración del presente Contrato se extenderá desde el id-dec-26 hasta que dure la ausencia del trabajador sustituido."
                  },
                  {
                    "identifier": "iddec0_opB_0-extra-2",
                    "insideId": "opC",
        ...
        "extraReplacements": [
          ...
          },
          {
            "identifier": "iddec0-extra-1",
            "insideId": "opB",
            "replacement": "iddec0_opB_0-extra-0",
            "replacementOriginal": "iddec0_opB_0-extra-0"
          },
          {
            "identifier": "iddec0-extra-2",
            "insideId": "opC",
            "replacement": "iddec0_opB_0-extra-1",
            "replacementOriginal": "iddec0_opB_0-extra-1"
          },
          {
            "identifier": "iddec0-extra-3",
            "insideId": "opD",
            "replacement": "iddec0_opB_0-extra-2",
            "replacementOriginal": "iddec0_opB_0-extra-2"
          },
          {
            "identifier": "iddec0-extra-4",
            "insideId": "opE",
            "replacement": "Particularmente, se regirá por el artículo 15 del Estatuto de los Trabajadores, aprobado por el Real Decreto Legislativo 2/2015, de 23 de octubre, y por el Real Decreto 2720/1998, de 18 de diciembre",
            "replacementOriginal": "Particularmente, se regirá por el artículo 15 del Estatuto de los Trabajadores, aprobado por el Real Decreto Legislativo 2/2015, de 23 de octubre, y por el Real Decreto 2720/1998, de 18 de diciembre"
          }
        ],
        "checked": false
      }
  ...
  },
  {
    ...
    "indications": {
      "areIndications": true,
      "indicationsType": "outsideText",
      "value": "Elija: 'En centros de trabajo móviles o itinerantes' si, de manera prioritaria, la prestación de trabajo no se ejecutará en uno o varios centros de trabajo fijos o permanentes, debido a que el lugar de trabajo es cambiante y está sujeto movilidad constante. El trabajador prestará sus servicios en este tipo de centros de trabajo, por ejemplo, cuando estos consistan en la participación en espectáculos artísticos, circos, o determinadas empresas de montajes o instalaciones industriales, eléctricas y telefónicas. Si el trabajador presta sus servicios en centros de trabajo móviles o itinerantes, la movilidad geográfica es libre para el empresario; es decir, se encuentra dentro de su poder de dirección empresarial."
    },
    "extraReplacements": [],
    "radios": [
      {
  ...
  },
  {
    ...
    "radios": [
      {
        "label": "Sí",
        "replacement": "Pacto de exclusividad y no competencia: El TRABAJADOR prestará sus servicios en régimen de dedicación exclusiva al EMPLEADOR, de manera que el TRABAJADOR no podrá prestar asesoramiento o servicios a favor de personas físicas o jurídicas que se dediquen a un objeto similar o que pueda considerarse competencia del EMPLEADOR. A cambio, y en como contraprestación de esta plena dedicación, el TRABAJADOR percibirá la compensación económica que en cada momento figure en el desglose de la nómina bajo este concepto.",
        "replacementOriginal": "Pacto de exclusividad y no competencia: El TRABAJADOR prestará sus servicios en régimen de dedicación exclusiva al EMPLEADOR, de manera que el TRABAJADOR no podrá prestar asesoramiento o servicios a favor de personas físicas o jurídicas que se dediquen a un objeto similar o que pueda considerarse competencia del EMPLEADOR. A cambio, y en como contraprestación de esta plena dedicación, el TRABAJADOR percibirá la compensación económica que en cada momento figure en el desglose de la nómina bajo este concepto.",
