export const steps = [
    ...
    // },
    {
      ...
      type: 'iCheckbox',
      replacementOriginal: 'Como parte anexa o accesoria a la misma, también incluye: iGaraje iTrastero. En adelante se denominará conjuntamente la finca y sus accesorios',
      replacement: '',
      checkboxes: [
        {
      ...
      rules: [
        {
          ...
          rulename: 'replace',
          replacement: 'En adelante, se denominará la Finca'
        }
      ]
    },
    {
