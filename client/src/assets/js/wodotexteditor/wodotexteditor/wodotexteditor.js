        ...
        */
        ...
        function startEditing() {
            ...
            if (editorOptions.formType !== 'fillForm') {
                ...
                const element = document.getElementById('webodfeditor-canvas' + instanceCounter);
        ...
        this.setDocumentToFitScreen = function() {
            return editorSession.getOdfCanvas().getZoomHelper().setZoomLevel((document.getElementById('webodfeditor-canvascontainer' + instanceCounter).offsetWidth / document.getElementById('webodfeditor-canvas' + instanceCounter).offsetWidth) );
        };
